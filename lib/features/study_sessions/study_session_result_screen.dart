  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      onPopInvokedWithResult: (didPop, _) {
        if (didPop && session != null) state.exitStudySession(session.id);
      },
      child: ResponsiveAppScaffold(
          ...
          child: ListView(
            children: [
              if (!usable)
                        ...
                        Padding(
                          ...
                          child: OutlinedButton(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                _answerLabel(context, session, option),
                              ),
                            ),
                          ),
                        ),
                ...
                const SizedBox(height: 12),
                FilledButton.icon(
                  key: const ValueKey('finish-study-session'),
                  onPressed: () {
                  ...
                  label: Text(context.l10n.quizFinishReview),
                ),
              ],
            ],
          ),
